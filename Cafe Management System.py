...
def email(msg):
    s = 'chandraneil.basa@bennett.edu.in'
    password = 'Donpowerup1498'
    r = ['basachandraneil@gmail.com']
...
def Reciept():
    ...
    txtReciept.insert(END,'Latta: \t\t\t\t\t'+ E_Latta.get()+"\n")
    txtReciept.insert(END,'Espresso:\t\t\t\t\t'+E_Espresso.get()+"\n")
    txtReciept.insert(END,  'Iced Latta:\t\t\t\t\t'+E_Iced_Latta.get()+"\n")
    txtReciept.insert(END, 'Vale Coffee:\t\t\t\t\t'+E_Vale_Coffee.get()+"\n")
    txtReciept.insert(END, 'Cappuccino:\t\t\t\t\t'+E_Cappuccino.get()+"\n")
    txtReciept.insert(END,'African Coffee:\t\t\t\t\t'+E_African_Coffee.get()+"\n")
    txtReciept.insert(END,'Amrican Coffee:\t\t\t\t\t'+E_Amrican_Coffee.get()+"\n")
    txtReciept.insert(END, 'Iced Cappuccino:\t\t\t\t\t'+E_Iced_Cappuccino.get()+"\n")
    txtReciept.insert(END, 'Coffee Cake:\t\t\t\t\t'+E_Coffee_Cake.get()+"\n")
    txtReciept.insert(END, 'Red Valvet Cake:\t\t\t\t\t'+E_Red_Valvet_Cake.get()+"\n")
    txtReciept.insert(END,'Black Forest Cake:\t\t\t\t\t'+E_Black_Forest_Cake.get()+"\n")
    txtReciept.insert(END, 'Boston Cream Cake:\t\t\t\t\t'+E_Boston_Cream_Cake.get()+"\n")
    txtReciept.insert(END,'Lagos Chocolate Cake:\t\t\t\t\t'+E_Lagos_Chocolate_Cake.get()+"\n")
    txtReciept.insert(END,'Kilburn Chocolate Cake:\t\t\t\t\t'+E_Kilburn_Chocolate_Cake.get()+"\n")
    txtReciept.insert(END,'Carlton Hill Chocolate Cake:\t\t\t\t\t'+E_Carlton_Hill_Chocolate_Cake.get()+"\n")
    txtReciept.insert(END,'Queens Park Chocolate Cake:\t\t\t\t\t'+E_Queens_Park_Chocolate_Cake.get()+"\n")
    txtReciept.insert(END,'Cost Of Drinks:\t\t'+CostofDrinks.get()+'\tTax Paid:\t\t'+PaidTax.get()+"\n")
    txtReciept.insert(END,'Cost Of Cakes:\t\t'+CostofCakes.get()+'\tSubTax Paid:\t\t'+SubTotal.get()+"\n")
    txtReciept.insert(END,'Service Charge:\t\t'+ServiseCharge.get()+'\tTotalCost:\t\t'+TotalCost.get()+"\n")
##----------------------------------------------------------------check buttons------------------------
...
Latta=Checkbutton(f1aa,text="Latta\t",variable = var1,onvalue=1,offvalue=0,command=checkbutton,
...
Iced_Latta=Checkbutton(f1aa,text="Iced Latta\t",variable = var3,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=2,sticky=W)
Vale_Coffee=Checkbutton(f1aa,text="Vale Coffee\t",variable = var4,onvalue=1,offvalue=0,command=checkbutton,
...
African_Coffee=Checkbutton(f1aa,text="African Coffee\t",variable = var6,onvalue=1,offvalue=0,command=checkbutton,
...
Coffee_Cake=Checkbutton(f1ab,text="Coffee Cake\t",variable = var9,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=0,sticky=W)
Red_Valvet_Cake=Checkbutton(f1ab,text="Red Valvet Cake\t",variable = var10,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=1,sticky=W)
Black_Forest_Cake=Checkbutton(f1ab,text="Black Forest Cake\t",variable = var11,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=2,sticky=W)
Boston_Cream_Cake=Checkbutton(f1ab,text="Boston Cream Cake\t",variable = var12,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=3,sticky=W)
Lagos_Chocolate_Cake=Checkbutton(f1ab,text="Lagos Chocolate Cake\t",variable = var13,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=4,sticky=W)
Kilburn_Chocolate_Cake=Checkbutton(f1ab,text="Kilburn Chocolate Cake\t",variable = var14,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=5,sticky=W)
Carlton_Hill_Chocolate_Cake=Checkbutton(f1ab,text="Carlton Hill Chocolate Cake\t",variable = var15,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=6,sticky=W)
Queens_Park_Chocolate_Cake=Checkbutton(f1ab,text="Queens Park Chocolate Cake\t",variable = var16,onvalue=1,offvalue=0,command=checkbutton,
                  font=('arial',18,'bold')).grid(row=7,sticky=W)
